...
def run_vm():
    local('qemu-system-x86_64 -m 256 -redir tcp:2222::22 -redir tcp:8000::80 -redir tcp:8443::443 \
...
def config_cloud_init():
    ...
    local('mkisofs -output %sinit.iso -volid cidata -joliet -rock %suser-data %smeta-data' %
